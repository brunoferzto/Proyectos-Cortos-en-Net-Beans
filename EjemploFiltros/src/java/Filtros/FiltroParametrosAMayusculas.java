...
public class FiltroParametrosAMayusculas implements Filter{
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
       if(request instanceof HttpServletRequest && response instanceof HttpServletResponse)
       {
           ...
           //ESTE CODIGO SE EJECUTA A LA IDA (POR ENCIMA DEL CHAIN)
         ...
         //ESTE CODIGO SE EJECUTA A LA VUELTA 
         
         PrintWriter salida = response.getWriter();
         
           try {
               String advertencia = "<p style=\"background-color: red; color: white font-weight: bold;\">¡Advertencia! Este Servlet ha sido filtado</p>";
